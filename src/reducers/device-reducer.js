import {FETCH_DEVICES,UPDATE_DEVICE,DELETE_DEVICE,ADD_DEVICE,ASSIGN_DEVICE,UNASSIGN_DEVICE} from '../actions/types'
...
const devicesReducer=(state=[],action)=>{
    if(action.type===FETCH_DEVICES){
        ...
        let devices = [...state].filter(device=>device.imei != action.payload.imei)
        return devices;
